...
<head>
  ...
  <title>About - KelvinCodes</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Faticons -->
  <?php
    include("templates/faticon.php")
  ?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">JS <i class="val">20%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">PHP frameworks <i class="val">20%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Github <i class="val">60%</i></span>
              <div class="progress-bar-wrap">
        ...
        <section id="interests" class="interests">
            ...
            <div class="interests container">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                  <div class="icon-box">
                    <i class="bi bi-filetype-py" style="color: #9F0707;"></i>
                    <h3>Python3</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
                  <div class="icon-box">
                    <i class="bi bi-filetype-php" style="color: #9F0707;"></i>
                    <h3>PHP</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                  <div class="icon-box">
                    <i class="bi bi-database" style="color: #9F0707;"></i>
                    <h3>MySQL</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                  <div class="icon-box">
                    <i class="bi bi-hdd-stack-fill" style="color: #9F0707;"></i>
                    <h3>Webhosting</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                  <div class="icon-box">
                    <i class="bi bi-motherboard" style="color: #9F0707;"></i>
                    <h3>PC building</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                  <div class="icon-box">
                    <i class="bi bi-controller" style="color: #9F0707;"></i>
                    <h3>Gaming</h3>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                  <div class="icon-box">
                    <i class="bi bi-broadcast" style="color: #9F0707;"></i>
                    <h3>RC stuff</h3>
                  </div>
                </div>
              </div>
